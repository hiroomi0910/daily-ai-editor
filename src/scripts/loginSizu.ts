...
async function run() {
  ...
  console.log("=========================================");
  console.log("しずかなインターネット (sizu.me) 手動ログインセッション保存スクリプト");
  ...
  console.log("ブラウザを起動しています... https://sizu.me/home を開きます。");
  await page.goto("https://sizu.me/home");

  console.log("\n【重要】ブラウザウィンドウでしずかなインターネットのアカウントに手動でログインしてください。");
  console.log("Googleログインやメールアドレス認証などを含め、ログインを完了させてください。");
  console.log("ログインが完了し、ダッシュボード（マイページ）が表示されたら、");
