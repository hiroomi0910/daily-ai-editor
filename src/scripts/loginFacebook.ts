...
async function run() {
  ...
  const sessionPath = config.facebookSessionPath;

  console.log("=========================================");
  console.log("Facebook 手動ログインセッション保存スクリプト");
  ...
  console.log("ブラウザを起動しています... https://www.facebook.com/ を開きます。");
  await page.goto("https://www.facebook.com/");

  console.log("\n【重要】ブラウザウィンドウでFacebookアカウントに手動でログインしてください。");
  console.log("二要素認証などを含め、ログインを完了させてください。");
  console.log("ログインが完了し、ホーム画面が表示されたら、");
